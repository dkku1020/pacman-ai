...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        self.QValues = util.Counter() # (state, action)
    ...
    def computeActionFromQValues(self, state):
        ...
        """
        legalActions = self.getLegalActions(state) # all legal actions
    ...
    def update(self, state, action, nextState, reward):
        ...
        newQVal += self.alpha * (reward + (self.discount * self.getValue(nextState)))
